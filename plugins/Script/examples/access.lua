...
settings.announcecfg =  {
	...
	help = "announce changes to hubname, description, topic, owner, website, network and limit settings in mainchat, 1 = enabled, 0 = disabled",
...
settings.failover = {
	...
	help = "comma separated list of failover address(es) for the hub in adc(s)://address:port,... format, empty = disabled",
...
settings.network = {
	help = "name of the network the hub belongs to (for hublist pingers)",
